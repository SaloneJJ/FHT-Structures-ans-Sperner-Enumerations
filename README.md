...
1. **(i) Partition by Connected Components:**  
...
2. **(ii) Top-Level Singularity and Connectedness:**  
...
4. **(iv) Fractal Inclusion (Strict Hierarchy):**  
...
6. **(vi) Hyperedge Non-Triviality (Maximal Children Coverage):**  
